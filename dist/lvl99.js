...
"use strict";
/* unused harmony export coerceToPrimitiveType */
/* unused harmony export convertToBoolean */
/* harmony export (immutable) */ __webpack_exports__["a"] = convertStringToJson;
/* unused harmony export convertStringToFloat */
/* harmony export (immutable) */ __webpack_exports__["c"] = extractClassDetails;
/* harmony export (immutable) */ __webpack_exports__["e"] = extractTriggerDetails;
/* unused harmony export fixedEncodeURIComponent */
/* harmony export (immutable) */ __webpack_exports__["f"] = getTargetBySelector;
/* harmony export (immutable) */ __webpack_exports__["g"] = getTargetSelector;
/* harmony export (immutable) */ __webpack_exports__["d"] = extractTargetEventNames;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_object_path__ = __webpack_require__(3);
...
>>>>>>> Stashed changes
          ...
          if (!__WEBPACK_IMPORTED_MODULE_0_object_path___default.a.has(output, objPartPath)) {
            // @debug
            // console.log('setting object part path', {
            //   output,
            //   partName,
            ...
            __WEBPACK_IMPORTED_MODULE_0_object_path___default.a.set(output, objPartPath, {});
          }
        }
      }

      // Set via objectPath
      __WEBPACK_IMPORTED_MODULE_0_object_path___default.a.set(output, partName, partValue);
    }
  });
...
function extractTriggerDetails(input, context) {
  ...
  // }
  if (!__WEBPACK_IMPORTED_MODULE_0_object_path___default.a.has(trigger, 'do')) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_0_object_path___default.a.has(trigger, 'target')) {
...
>>>>>>> Stashed changes
  ...
  if (__WEBPACK_IMPORTED_MODULE_0_object_path___default.a.has(trigger, 'context')) {
...
/* harmony default export */ __webpack_exports__["b"] = (parse);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_merge__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_object_path__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_inheritance__ = __webpack_require__(6);
...
var Entity = function () {
  ...
  function Entity(attributes) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_3__utils_inheritance__["b" /* exposePrivateProperties */])(this);

    // Create a unique ID for this Entity
    Object.defineProperty(this, 'uuid', {
      value: this.NS + ':' + __WEBPACK_IMPORTED_MODULE_0_uuid___default.a.v4(),
      writable: false,
      enumerable: true,
      configurable: false
    });
  ...
  _createClass(Entity, [{
    ...
    value: function extend() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default.a.apply(undefined, [this, EntityProperties].concat(Array.prototype.slice.call(arguments)));
    ...
    value: function getProp(propName) {
      ...
      return __WEBPACK_IMPORTED_MODULE_2_object_path___default.a.get(this.properties, propName);
    }
    ...
    value: function setProp(propName, propValue) {
      ...
      return __WEBPACK_IMPORTED_MODULE_2_object_path___default.a.set(this.properties, propName, propValue);
    }
    ...
    value: function getAttr(attrName) {
      ...
      return __WEBPACK_IMPORTED_MODULE_2_object_path___default.a.get(this.attributes, attrName);
    }
    ...
    value: function setAttr(attrName, attrValue) {
      ...
      return __WEBPACK_IMPORTED_MODULE_2_object_path___default.a.set(this.attributes, attrName, attrValue);
    }
...
"use strict";
/* unused harmony export exposeAllProperties */
/* harmony export (immutable) */ __webpack_exports__["b"] = exposePrivateProperties;
/* unused harmony export createPublicGetProperty */
/* unused harmony export createPublicGetSetProperty */
/**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tools__ = __webpack_require__(19);
/**
 * LVL99
 *
...
var lvl99 = {
  common: __WEBPACK_IMPORTED_MODULE_0__common__["c" /* default */],
  core: __WEBPACK_IMPORTED_MODULE_2__core__["a" /* default */],
  utils: __WEBPACK_IMPORTED_MODULE_1__utils__["a" /* default */],
  tools: __WEBPACK_IMPORTED_MODULE_3__tools__["a" /* default */]
};

/* harmony default export */ __webpack_exports__["default"] = (lvl99);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parse__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__inheritance__ = __webpack_require__(6);
/**
 * LVL99 Utils
 *
...
var utils = {
  parse: __WEBPACK_IMPORTED_MODULE_0__parse__["b" /* default */],
  inheritance: __WEBPACK_IMPORTED_MODULE_1__inheritance__["a" /* default */]
};
...
var core = {
  Entity: __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */],
  App: __WEBPACK_IMPORTED_MODULE_1__app__["a" /* default */],
  Component: __WEBPACK_IMPORTED_MODULE_2__component__["a" /* default */]
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_parse__ = __webpack_require__(2);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var App = function (_Entity) {
  ...
  _createClass(App, [{
    ...
    value: function initialiseComponents() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_0__common__["a" /* $ */])('[data-component]')
      // Ignore components which already have an ID assigned
      .not('[data-component-id]')
      // Initialise each component
      .each(function (index, elem) {
        var $elem = Object(__WEBPACK_IMPORTED_MODULE_0__common__["a" /* $ */])(elem);
        var elemComponentClass = $elem.attr('data-component');
        var elemComponentOptions = $elem.attr('data-component-options') || {};
        ...
        if (typeof elemComponentOptions === 'string') {
          ...
          if (/^\{/.test(elemComponentOptions)) {
            elemComponentOptions = Object(__WEBPACK_IMPORTED_MODULE_3__utils_parse__["a" /* convertStringToJson */])(elemComponentOptions);

            // Set as style-like attributes, e.g. `name: value; name: value`
          } else {
            elemComponentOptions = Object(__WEBPACK_IMPORTED_MODULE_3__utils_parse__["c" /* extractClassDetails */])(elemComponentOptions);
          }
        }
  ...
  return App;
}(__WEBPACK_IMPORTED_MODULE_2__entity__["a" /* default */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__entity__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_parse__ = __webpack_require__(2);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
  ...
  _createClass(Component, [{
    ...
    value: function extend() {
      ...
      args.forEach(function (arg) {
        var hasPublicMethods = __WEBPACK_IMPORTED_MODULE_0_object_path___default.a.get(arg, '_properties.publicMethods');
    ...
    value: function getElem() {
      ...
      if (typeof this.getAttr('elem') === 'string' || typeof this.getAttr('$elem') === 'string') {
        var $elem = Object(__WEBPACK_IMPORTED_MODULE_4__common__["a" /* $ */])(this.getAttr('elem'));
        if ($elem.length) {
      ...
      if (this.getAttr('elem') && !this.getAttr('$elem')) {
        this.setAttr(Object(__WEBPACK_IMPORTED_MODULE_4__common__["a" /* $ */])(this.getAttr('elem')));
      }
    ...
    value: function loadAttrs() {
      if (this.getElem() && this.getElem().is('[data-component-attributes]')) {
        ...
        this._attributes = __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this._attributes, attrs);
        ...
        publicMethods.forEach(function (trigger) {
          ...
          if ((typeof trigger === 'undefined' ? 'undefined' : _typeof(trigger)) === 'object') {
            ...
            if (/^{/.test(trigger) || /[:;]/.test(trigger)) {
              triggerDetails = Object(__WEBPACK_IMPORTED_MODULE_5__utils_parse__["e" /* extractTriggerDetails */])(trigger);
            } else {
          ...
          if (!__WEBPACK_IMPORTED_MODULE_0_object_path___default.a.has(triggerDetails, 'on')) {
    ...
    value: function bindEventToTarget(eventName, method, target) {
      ...
      var eventNames = Object(__WEBPACK_IMPORTED_MODULE_5__utils_parse__["d" /* extractTargetEventNames */])(eventName, this.NS);
      ...
      // Assign the trigger
      if (eventNames) {
        Object(__WEBPACK_IMPORTED_MODULE_4__common__["a" /* $ */])(target).on(eventNames.join(' '), method);
      }
    }
    ...
    key: 'bindEventToTargetSelector',
    value: function bindEventToTargetSelector(eventName, selector, method, target) {
      target = Object(__WEBPACK_IMPORTED_MODULE_5__utils_parse__["f" /* getTargetBySelector */])(target, this);
      selector = Object(__WEBPACK_IMPORTED_MODULE_5__utils_parse__["g" /* getTargetSelector */])(selector, this);
      var eventNames = Object(__WEBPACK_IMPORTED_MODULE_5__utils_parse__["d" /* extractTargetEventNames */])(eventName, this.NS);
      ...
      if (eventNames) {
        Object(__WEBPACK_IMPORTED_MODULE_4__common__["a" /* $ */])(target).on(eventNames.join(' '), selector, method);
      }
    }
    ...
    value: function triggerEvent(eventName) {
      ...
      __WEBPACK_IMPORTED_MODULE_4__common__["b" /* $doc */].trigger(this.NS + ':' + eventName, [this].concat(args));
    }
    ...
    value: function triggerEventOnSelector(eventName, selector) {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_4__common__["a" /* $ */])(selector).trigger(this.NS + ':' + eventName, [this].concat(args));
    }
  }]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__breakpoints__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__debug__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__queue__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__trackevent__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__smooth_scroll__ = __webpack_require__(24);
/**
 * LVL99 Tools
 *
...
var utils = {
  ...
  Debug: __WEBPACK_IMPORTED_MODULE_1__debug__["a" /* default */],
  Queue: __WEBPACK_IMPORTED_MODULE_2__queue__["a" /* default */],
  TrackEvent: __WEBPACK_IMPORTED_MODULE_3__trackevent__["a" /* default */],
  SmoothScroll: __WEBPACK_IMPORTED_MODULE_4__smooth_scroll__["a" /* default */]
};
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = Breakpoints;
...
function Queue(options) {
   ...
   * @private
   */
  var _options = __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()({
    queue: {},
    timer: 0,
    timerDelay: 100
  }, options);
