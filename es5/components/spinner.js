    ...
    value: function init() {
      ...
      if (this.getAttr('_spinnerWatchTarget')) {
        if (this.getAttr('_spinnerWatchEventsForStart')) {
          $doc.on(this.getAttr('_spinnerWatchEventsForStart'), this.getAttr('_spinnerWatchTarget'), function (jQueryEvent) {
            _this2.startSpinning();
          });
        }

        if (this.getAttr('_spinnerWatchEventsForStop')) {
          $doc.on(this.getAttr('_spinnerWatchEventsForStop'), this.getAttr('_spinnerWatchTarget'), function (jQueryEvent) {
            _this2.stopSpinning();
          });
        }
      }
